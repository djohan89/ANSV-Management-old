...
<body>
<c:url value="/chief/updateProjectCEO/${week}_${year}_${project.id}" var="updateProjectCEO"/>
<form:form action="${updateProjectCEO}" method="POST" modelAttribute="project">
							...
							<div class="card bg-gradient-secondary collapsed-card">
								...
								<div class="card-body">
									<div class="input-group mb-3">
										...
										<form:textarea path="ke_hoach" class="form-control" id="cr_tinh_trang" />
									</div>
