	...
	<div class="content-wrapper">
		...
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1 class="m-0">Dashboard${display_name}</h1>
					</div>
					<!-- /.col -->
					<div class="col-sm-6">
							...
							<div class="card-body">
								...
								<div class="direct-chat-messages">
									...
									<div class="direct-chat-msg">
										...
										<img class="direct-chat-img"
											src="<c:url value='/assets/user/dist/img/user1-128x128.jpg' />"
								...
								<div class="direct-chat-contacts">
									<ul class="contacts-list">
										...
										<!-- End Contact Item -->
										<li><a href="#"> <img class="contacts-list-img"
												src="<c:url value='/assets/user/dist/img/user7-128x128.jpg' />"
												alt="User Avatar">
										...
										<!-- End Contact Item -->
										<li><a href="#"> <img class="contacts-list-img"
												src="<c:url value='/assets/user/dist/img/user5-128x128.jpg' />"
												alt="User Avatar">
										...
										<!-- End Contact Item -->
										<li><a href="#"> <img class="contacts-list-img"
												src="<c:url value='/assets/user/dist/img/user6-128x128.jpg' />"
												alt="User Avatar">
										...
										<!-- End Contact Item -->
										<li><a href="#"> <img class="contacts-list-img"
												src="<c:url value='/assets/user/dist/img/user8-128x128.jpg' />"
												alt="User Avatar">
