			...
			<ul class="nav nav-pills nav-sidebar flex-column nav-flat"
				...
				<li class="nav-item ">
					<a href="#" class="nav-link ">
						...
						<p>
							Tài khoản <i class="right fas fa-angle-left"></i>
						</p>
					</a>
				...
				<li class="nav-item ">
					<a href="#" class="nav-link ">
						<i class="nav-icon fas fa-clipboard-list"></i>
						<p>
							Triển khai <i class="right fas fa-angle-left"></i>
						</p>
					</a>
					<ul class="nav nav-treeview">
						<li class="nav-item">
				...
				<li class="nav-item">
					<a href="#" class="nav-link">
						<i class="nav-icon fas fa-clipboard-list"></i>
						<p>
							Viễn thông <i class="right fas fa-angle-left"></i>
						</p>
					</a>
					<ul class="nav nav-treeview">
						<li class="nav-item">
				...
				<li class="nav-item">
					<a href="#" class="nav-link">
						<i class="nav-icon fas fa-clipboard-list"></i>
						<p>
							Chuyển đổi số <i class="right fas fa-angle-left"></i>
						</p>
					</a>
					<ul class="nav nav-treeview">
						<li class="nav-item">
